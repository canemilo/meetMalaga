...
@Component({
  ...
  template: `
    <app-legal-layout title="Aviso de afiliados" i18n-title="@@legal.afiliados.title">
      <p i18n="@@legal.afiliados.intro">
      ...
      <h2 i18n="@@legal.afiliados.significado.title">¿Qué significa esto?</h2>
      <p i18n="@@legal.afiliados.significado.text">
      ...
      <h2 i18n="@@legal.afiliados.compromiso.title">Nuestro compromiso</h2>
      <ul>
        <li i18n="@@legal.afiliados.compromiso.item1">Recomendamos servicios por su interés, no por la comisión.</li>
        <li i18n="@@legal.afiliados.compromiso.item2">Los precios mostrados son orientativos; el precio final lo fija cada plataforma.</li>
        <li i18n="@@legal.afiliados.compromiso.item3">No gestionamos pagos ni reservas: eso lo hace directamente el proveedor.</li>
      </ul>
      <p i18n="@@legal.afiliados.duda">
