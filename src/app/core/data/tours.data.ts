...
export const TOURS: Offer[] = [
  {
    ...
    vertical: 'tours',
    provider: 'civitatis',
    title: 'Alcazaba y Castillo de Gibralfaro',
    summary:
      'Recorre la fortaleza musulmana mejor conservada de España y sube al mirador con las mejores vistas de la bahía.',
    imageUrl: 'https://picsum.photos/seed/alcazaba/800/600',
    imageAlt: 'Murallas de la Alcazaba de Málaga al atardecer',
    priceFrom: 18,
    rating: 4.8,
    duration: '2,5 horas',
  ...
  },
  {
    ...
    vertical: 'tours',
    provider: 'civitatis',
    title: 'Caminito del Rey desde Málaga',
    summary:
      'La pasarela colgada sobre el desfiladero de los Gaitanes, con transporte de ida y vuelta incluido.',
  ...
  },
  {
    ...
    summary:
      'Cinco paradas gastronómicas con vino y especialidades malagueñas guiadas por un local.',
    imageUrl: 'https://picsum.photos/seed/tapas/800/600',
    imageAlt: 'Tapas y vino en una taberna del centro de Málaga',
    priceFrom: 45,
    rating: 4.7,
    duration: '3 horas',
  ...
  },
  {
    ...
    summary:
      'Entrada a la colección permanente en la ciudad natal del pintor, en el Palacio de Buenavista.',
    imageUrl: 'https://picsum.photos/seed/picasso/800/600',
    imageAlt: 'Fachada del Museo Picasso de Málaga',
    priceFrom: 12,
    rating: 4.6,
    duration: '1,5 horas',
  ...
  },
  {
    ...
    vertical: 'tours',
    provider: 'civitatis',
    title: 'Paseo en catamarán por la bahía',
    summary:
      'Navegación de una hora frente a la costa con baño opcional y vistas del skyline de Málaga.',
    imageUrl: 'https://picsum.photos/seed/catamaran/800/600',
    imageAlt: 'Catamarán navegando frente a la costa de Málaga',
    priceFrom: 20,
    rating: 4.5,
    duration: '1 hora',
  ...
  },
  {
    ...
    vertical: 'tours',
    provider: 'getyourguide',
    title: 'Nerja y Frigiliana con cuevas',
    summary:
      'Excursión a los pueblos blancos de la Axarquía y a las famosas Cuevas de Nerja.',
    imageUrl: 'https://picsum.photos/seed/frigiliana/800/600',
    imageAlt: 'Calles blancas de Frigiliana con flores',
    priceFrom: 42,
    rating: 4.7,
    duration: 'Día completo',
