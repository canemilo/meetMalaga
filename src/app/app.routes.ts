  ...
  },
  {
    ...
    data: {
      config: {
        ...
        metaDescription: 'Descubre los mejores tours y visitas guiadas en Málaga: desde la Alcazaba hasta el Caminito del Rey, con guías locales y reserva online segura.',
        offersHeading: 'Tours disponibles en Málaga',
      },
    },
  },
  {
    ...
    data: {
      config: {
        ...
        metaDescription: 'Alquila coche en Málaga al mejor precio: compara compañías con recogida en el aeropuerto o el centro, cancelación gratuita y sin sorpresas ocultas.',
        offersHeading: 'Coches de alquiler disponibles',
      },
    },
  },
  {
    ...
    data: {
      config: {
        ...
        metaDescription: 'Encuentra los mejores restaurantes de Málaga, del pescaíto frito a la estrella Michelin. Consulta valoraciones y reserva mesa en los que sí merecen la pena.',
        offersHeading: 'Restaurantes recomendados en Málaga',
      },
    },
  },
  {
    ...
    data: {
      config: {
        ...
        metaDescription: 'Vive el mejor ocio en Málaga: flamenco, baños árabes, kayak y planes para todos los gustos. Descubre actividades y reserva online en segundos.',
        offersHeading: 'Planes de ocio disponibles en Málaga',
      },
    },
  },
